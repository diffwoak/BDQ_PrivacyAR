...
# IPN数据集
python train.py --multiprocessing-distributed --datadir /root/autodl-tmp/IPN_splits --dataset IPN --groups 32 --dense_sampling --weight 10 --without_t_stride -b 8 --lr 0.003
# 固定BDQ 训练动作识别网络
